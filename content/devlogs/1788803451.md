...
[by taking inspiration from Github user spookyorange](https://github.com/spookyorange).
...
```bash
curl -fsSL https://gist.githubusercontent.com/Pratyay360/cfb1a617d8631d2a0c5f28c6f070d53c/raw/7ccf569a76d5d1ab035075afcc0ff5754456bbb8/firefox.sh | sh
```

BetterBird:

```bash
curl -fsSL https://gist.githubusercontent.com/Pratyay360/80d3b9b659d2271c82adcc15ba4f7985/raw/fd68607e467f8d8318da7e98e0ab74e5b51cc57b/betterbird.sh | sh
```

Flow Control (text editor):

```bash
curl -fsSL https://gist.githubusercontent.com/Pratyay360/e620aca918d2106d983026dae09a9f61/raw/6743a7bc99f2bad55a0d6583fbb267590d0dd832/flow.sh | sh
```

> Safety Warning: Generally, it is recommended not to run random scripts from the internet on your machine. Always verify the contents of a script before executing it. You can do this by running curl [https://some](https://some)script.sh to inspect the code safely from your terminal.
