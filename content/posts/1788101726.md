...
description: my Linux journey so far (hashnode)
...
It was during the COVID lockdown; my school was off and I was binge-watching YouTube videos on my Windows desktop. Suddenly, I encountered a video about Linux and "riced" UI stuff. I was very amused by how good-looking and minimalistic in nature it was, so I decided to switch the OS of my desktop. I was a little bit scared about my ability to use Linux, which is why I downloaded an Ubuntu ISO, as Ubuntu comes up first when searching for something about Linux. I installed Virtual Box and tried it out by following some YouTube tutorials. It was good, and most of the software I used to use were pirated proprietary ones like Photoshop and Microsoft Office. Also, being good with the terminal was important so that if I messed something up, I would be capable of repairing it with some Google searches and YouTube videos. So, I installed Ubuntu WSL on my Windows machine and started learning basic commands used in the Unix world. Tbh, I loved spending time on the terminal and VS Code at that time like crazy. I was just coding and learning new stuff from YouTube, sitting in front of the monitor all day. After using WSL for 1–1.5 months and using Ubuntu on VirtualBox, my love for Linux grew surprisingly. My desktop at home used to have less RAM, so the VirtualBox experience was not that good for me.

!\[Windows Subsystem for Linux - Wikipedia\]([https://upload.wikimedia.org/wikipedia/commons/2/27/Ubuntu\_on\_Windows\_10\_-\_bash.png](https://upload.wikimedia.org/wikipedia/commons/2/27/Ubuntu_on_Windows_10_-_bash.png) align="center")
...
!\[Ubuntu Desktop\]([https://res.cloudinary.com/canonical/image/fetch/f\_auto,q\_auto,fl\_sanitize,c\_fill,w\_3840,h\_2160/https://ubuntu.com/wp-content/uploads/d944/yaru-screenshot-large.jpg](https://res.cloudinary.com/canonical/image/fetch/f_auto,q_auto,fl_sanitize,c_fill,w_3840,h_2160/https://ubuntu.com/wp-content/uploads/d944/yaru-screenshot-large.jpg) align="left")
...
!\[Kali Linux | Penetration Testing and Ethical Hacking Linux ...\]([https://www.kali.org/images/kali-desktop-gnome.jpg](https://www.kali.org/images/kali-desktop-gnome.jpg) align="left")
...
!\[\]([https://cdn.hashnode.com/res/hashnode/image/upload/v1734346269192/a55b5cc6-2c0c-4204-9b61-463f54161f71.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1734346269192/a55b5cc6-2c0c-4204-9b61-463f54161f71.png) align="center")
...
\*   With Linux, I realized I wasn’t just a passive consumer; I was part of a larger movement that values sharing knowledge and empowering users.
