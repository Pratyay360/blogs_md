...
One containing all the media and specially cli tools in a arch based toolbox. and another just for testing my [apps](https://github.com/Pratyay360/drawx). All my web browsers are downloaded via the arch toolbx. 
...
[![storage](https://i.ibb.co/qMT4hNN6/storage.gif)](https://ibb.co/hR3nrBB0)
