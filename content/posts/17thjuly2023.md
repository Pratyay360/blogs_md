...
description: Speed Up Compilation of React.js and Next.js Apps(hashnode-archieve)
...
If you are using Next.js, you need to rename your `Next.config.js` file to `Next.config.mjs`
